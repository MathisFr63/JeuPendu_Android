...
import com.example.mafrizot1.pendutest.model.DeviceListAdapter;
...
public class BTActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private BroadcastReceiver mBroadcastReceiver3 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // Si l'action est la recherche d'appareils "découvrables" (discoverable), on les ajoute à la liste et on les affiche sur la vue.
            if (action.equals(BluetoothDevice.ACTION_FOUND)) {
                BluetoothDevice device = intent.getParcelableExtra(BluetoothDevice.EXTRA_DEVICE);
                mBTDevices.add(device);
                Log.d(TAG, "onReceive: " + device.getName() + ": " + device.getAddress());
                mDeviceListAdapter = new DeviceListAdapter(context, R.layout.device_adapter_view, mBTDevices);
//                 L'adaptateur de la liste des appareils est set sur celui instacié au dessus et affichant les appareils découverts.
...
//    remember the connection will fail and app will crash if you haven't paired first
    ...
    public void startBtConnection(BluetoothDevice device, UUID uuid) {
        ...
        if(device != null) {
            ...
            Toast.makeText(getApplicationContext(), "Connexion Bluetooth impossible, Veuillez sélectionner un appareil", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2) {
            ...
            bluetoothConnectionService = new BluetoothConnectionService(BTActivity.this);
        }
    }
}
